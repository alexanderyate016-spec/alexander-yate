...
export const ExecutiveSelect: React.FC<ExecutiveSelectProps> = ({
  ...
  return (
    <div className="space-y-1.5 w-full">
      {label && (
        <label htmlFor={selectId} className="block text-[11px] font-bold uppercase tracking-wider text-slate-300">
      ...
      <div className="relative">
        ...
        <select
          ...
          className={`w-full bg-[#132337]/90 border ${
            ...
            icon ? 'pl-9' : 'px-3.5'
          } py-2 text-xs text-white font-sans transition-all focus:outline-none ${
