      ...
      <div className="bg-[#0B1726] border border-amber-500/40 rounded-2xl max-w-2xl w-full shadow-2xl overflow-hidden text-white my-8">
        ...
        <div className="p-5 bg-gradient-to-r from-amber-950/60 via-slate-900 to-slate-900 border-b border-amber-500/30 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-amber-500/20 rounded-xl border border-amber-500/40 text-amber-300">
        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="bg-[#132337] border border-amber-500/30 rounded-xl p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {/* Event A */}
              <div className="p-3 bg-slate-900/80 border border-slate-700/60 rounded-lg space-y-1 text-xs">
                ...
                {eventA.subtitle && (
                  <div className="text-[11px] text-slate-400">{eventA.subtitle}</div>
                )}
              </div>
              ...
              <div className="p-3 bg-slate-900/80 border border-slate-700/60 rounded-lg space-y-1 text-xs">
                ...
                {eventB.subtitle && (
                  <div className="text-[11px] text-slate-400">{eventB.subtitle}</div>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <button
                ...
                className={`p-3 text-left rounded-xl border transition-all flex items-start gap-2.5 ${
                  mode === 'permitted_absence'
                    ...
                    : 'bg-[#132337] border-slate-700/60 text-slate-300 hover:border-slate-500'
                }`}
              >
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400">Registra permiso solicitado / ausencia justificada</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400">Cambia fecha o rango de horas del evento</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400">Marca como cancelado sin borrar el historial</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400">Mantiene ambos eventos y limpia la alerta</div>
                </div>
              </button>
          ...
          {/* DYNAMIC ACTION FORM */}
          {mode !== 'none' && (
            <div className="p-4 bg-slate-900/90 border border-slate-700 rounded-xl space-y-4">
              ...
              {mode === 'reschedule_event' && (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      <label className="text-[11px] text-slate-300 block mb-1">Nueva Fecha</label>
                      <input 
                        type="date"
                        value={rescheduleDate}
                        onChange={e => setRescheduleDate(e.target.value)}
                        className="w-full p-2 bg-[#132337] border border-blue-500/40 rounded-lg text-xs text-white font-mono"
                      />
                    </div>
                    <div>
                      <label className="text-[11px] text-slate-300 block mb-1">Hora Inicio</label>
                      <input 
                        type="time"
                    ...
                    <div>
                      <label className="text-[11px] text-slate-300 block mb-1">Hora Fin</label>
                      <input 
                        type="time"
                        value={rescheduleEnd}
              ...
              {(mode === 'permitted_absence' || mode === 'cancel_event') && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 bg-[#132337] border border-slate-600 rounded-lg text-xs text-white"
                  />
                </div>
              )}
